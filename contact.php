...
<body>
    <ul class="nav">
        ...
        <li class="right"><a class="nav-link active" href="../ist-405-digital-animal-adoption/contact.php">Contact</a></li>
    ...
    <div class="content content-padding header-padding">
        <div class="center-content">
            <h1 class="center">Direct Contact Information and Social Media:</h1>
            ...
            <ul class="clean-list">
                ...
                <li><p>Email: digital_animal_adoption@daa.com</p></li>
            </ul>

            <h1 class="center">Have an animal to Donate?</h1>
            <a class="button" href="../ist-405-digital-animal-adoption/forms/donate.php">Donate</a>
        </div>
    </div>
</body>
</html>
