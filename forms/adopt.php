...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../ist-405-digital-animal-adoption/../ist-405-digital-animal-adoption/css/main.css" />
...
<body>
    <ul class="nav">
        ...
        <li class="right"><a class="nav-link active" href="../ist-405-digital-animal-adoption/available.php">Adoption</a></li>
        
    </ul>
    <div class="content content-padding header-padding">
        <div class="center-content">
    
            <form class="large" action="../ist-405-digital-animal-adoption/available.php" method="post" >
